...
- If a change might break other parts of the app, stop and ask before continuing.

## No dangerous terminal actions
- Only run read-only or safe commands by default (tests, linters, listing files).
- Ask for confirmation before any command that installs, deletes, or migrates.
