    ...
    return (
        <div className="h-screen flex bg-dark-900 overflow-hidden">
            ...
            {isLessonPhase ? (
                ...
                /* CHALLENGE PHASE: 3-column layout */
                    ...
                    <header className="glass-dark px-4 py-2.5 flex items-center justify-between shrink-0 border-b border-white/5">
                        <div className="flex items-center gap-3">
                            <button
                                ...
                                className="text-xs text-slate-500 hover:text-accent-purple transition-colors flex items-center gap-1"
                            >
                            ...
                            <span className="text-xs font-medium text-accent-cyan px-2 py-1 bg-accent-cyan/10 rounded border border-accent-cyan/20">
                                {currentChallenge.category}
                            </span>
                            <h1 className="text-base font-semibold text-white">
                                {currentChallenge.title}
                            </h1>
                            <span className={`text-xs font-medium px-2 py-0.5 rounded ${currentChallenge.difficulty === 'Beginner' ? 'bg-accent-green/10 text-accent-green border border-accent-green/20' :
